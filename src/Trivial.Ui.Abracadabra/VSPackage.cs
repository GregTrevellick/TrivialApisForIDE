...
using Trivial.Ui.Abracadabra;
using Trivial.Ui.Abracadabra.Options;
    ...
    public sealed class VSPackage : Package
    {
        ...
        private void OnSolutionOpened()
        {
            ...
            if (shouldShowTrivia)
            {
                ...
                var hiddenOptionsDto = new TriviaMessage().ShowTrivia(AppName.Abracadabra, popUpTitle, GeneralOptionsDto.LastPopUpDateTime, GeneralOptionsDto.PopUpCountToday, GeneralOptionsDto.TimeOutInMilliSeconds, Vsix.Name);
