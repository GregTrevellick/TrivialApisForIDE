...
namespace Trivial.Ui.Common
{
    public static class CommonConstants
    {
        ...
        public const string MaximumPopUpsWeekDayOptionLabel = "Midweek daily pop-up limit";//"Maximum week day pop-up messages";
        ...
        public const string MaximumPopUpsWeekEndOptionLabel = "Weekend pop-up limit";//"Maximum weekend pop-ups messages";
